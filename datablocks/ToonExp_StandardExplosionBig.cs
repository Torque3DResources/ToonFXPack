...
{
   textureName          = "data/ToonFXPack/images/toon_smoke";
...
{
   textureName          = "data/ToonFXPack/images/toon_explosion";
...
{
   textureName          = "data/ToonFXPack/images/toon_blast";
...
{
   textureName          = "data/ToonFXPack/images/toon_spark";
   gravityCoefficient   = "0.0";   
   lifetimeMS           = 200;
   lifetimeVarianceMS   = 50;
...
{
   textureName          = "data/ToonFXPack/images/toon_starBig";
   dragCoefficient      = "3";
   gravityCoefficient   = "-0.1";   
   lifetimeMS           = 600;
